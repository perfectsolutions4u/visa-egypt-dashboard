...
class AmenityDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->editColumn('created_at', fn(Amenity $amenity) => $amenity->created_at->format('M Y, d'))
            ->addColumn('action', 'dashboard.amenities.action')
            ->editColumn('name', fn(Amenity $amenity) => $amenity->name)
