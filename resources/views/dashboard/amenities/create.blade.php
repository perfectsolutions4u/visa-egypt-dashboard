...
@section('content')
    <form action="{{ route('dashboard.amenities.store' ) }}" method="POST" class="page-body">
        @csrf

        <!-- Container-fluid starts-->
        <x-dashboard.partials.breadcrumb title="Create Amenity" :hideFirst="true">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-dashboard.form.input-text error-key="icon_name" name="icon_name" id="icon_name"
