...
@section('content')
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-dashboard.form.input-checkbox resource-name="FAQ"
                                                         :value="$faq->active"
                                                         error-key="active"
    ...
    <x-dashboard.partials.resource-translation model="Faq" :id="$faq->id" />
@endsection
