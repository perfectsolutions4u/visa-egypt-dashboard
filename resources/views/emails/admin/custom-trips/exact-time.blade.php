...
<table border="0" cellpadding="0" cellspacing="0" align="left" style="width: 100%;margin-bottom: 50px;">
    <tbody>
        ...
        <tr align="left" >
            <td style="border-bottom: 1px solid #0003; padding: 8px">Start Date</td>
            <td style="border-bottom: 1px solid #0003; padding: 8px;">{{ $trip->start_date->toDateString() }}</td>
        </tr>
        <tr align="left" >
            <td style="border-bottom: 1px solid #0003; padding: 8px">End Date</td>
            <td style="border-bottom: 1px solid #0003; padding: 8px;">{{ $trip->end_date->toDateString() }}</td>
        </tr>
        <tr align="left" >
