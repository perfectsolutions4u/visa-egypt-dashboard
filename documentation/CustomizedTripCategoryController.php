...
class CustomizedTripCategoryController extends Controller
{
    ...
    /**
     * Get List CustomizedTripCategory
     * @OA\Get (
     *     path="/api/customized-trip-categories",
     *     tags={"CustomizedTripCategories"},
     *    @OA\Parameter(
     *         description="Filter CustomizedTripCategories By Name",
     *         in="query",
     *         name="name",
     *         required=false,
     ...
     *             type="string",
     *             example="http://baseURL/customized-trip-categories?page=2"
     *             ),
     *         @OA\Property(
     *             property="path",
     *             type="string",
     *             example="http://baseURL/customized-trip-categories"
     *             ),
     *         @OA\Property(
     *             property="per_page",
     *             type="number",
    ...
    /**
     * Get Detail CustomizedTripCategory
     * @OA\Get (
     *     path="/api/customized-trip-categories/{id}",
     *     tags={"CustomizedTripCategories"},
     *     @OA\Parameter(
     *         in="path",
     *         name="id",
